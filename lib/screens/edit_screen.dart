            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  //Title
                  XLabledTextField(
                    fontSize: Dimension.getWidth(context, 15),
                    label: "Title",
                  ...
                  //If imgURl is equal to empty String then image hasn't been loaded. So It will load
                  // only placeholder image.
                  // If _imgBytes is not null then image is changed so it will display and
                  // the new image.
                  GestureDetector(
                      onTap: () async {
                      ...
                      child: _imgBytes
                          ...
                          ? Image.memory(_imgBytes[0]!, width: 800)
                          : _imageURL.isNotEmpty
                              ? Image.network(_imageURL.first!, width: 800)
