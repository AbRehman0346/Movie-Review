...
class EditScreen_sm extends StatefulWidget {
  final DocumentSnapshot doc;
  const EditScreen_sm({Key? key, required this.doc}) : super(key: key);

  @override
  State<EditScreen_sm> createState() => _EditScreen_smState();
}

class _EditScreen_smState extends State<EditScreen_sm> {
