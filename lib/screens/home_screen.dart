...
import 'package:movie_review/screens/feedback.dart' as feedback;
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
              ...
              children: [
                ...
                Container(
                  ...
                  height: Dimension.getWidth(
                      context, Dimension.getHeightPercent(context, 80)),
                  ...
                  child: Column(
                    ...
                    children: [
                      XText(
                        "Movie Reviews",
                        color: Colors.white,
                        fontSize: Dimension.getHeight(context, 40),
                      ),
                      SizedBox(height: Dimension.getHeight(context, 20)),
                      SizedBox(
                        width: Dimension.getWidthPercent(context, 50),
                        //Hero TextField
                        child: TextField(
                          style: TextStyle(
                            color: Colors.white,
            ...
            //loaded from docs variable not from database.
            docs.isEmpty
                ? FutureBuilder(
            ...
            // ListViewLayout(docs: docs, searchValue: searchValue)
          ],
        ),
      ),
    );
