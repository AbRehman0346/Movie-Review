...
class DisplayMdScreen extends StatefulWidget {
  final DocumentSnapshot doc;
  DisplayMdScreen({Key? key, required this.doc}) : super(key: key);

  @override
  State<DisplayMdScreen> createState() => _DisplayMdScreenState();
}

class _DisplayMdScreenState extends State<DisplayMdScreen> {
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            // height: Dimension.getHeight(context, 400),
                            child: XTextField(
