...
class AddReview_md extends StatefulWidget {
  const AddReview_md({Key? key}) : super(key: key);

  @override
  State<AddReview_md> createState() => _AddReview_mdState();
}

class _AddReview_mdState extends State<AddReview_md> {
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  //Title
                  XLabledTextField(
                    fontSize: Dimension.getWidth(context, 100),
                    label: "Title: ",
                    labelFontSize: 40,
                    height: Dimension.getHeight(context, 300),
                    width: Dimension.getWidth(context, 1500),
                  ...
                  quill.QuillToolbar.simple(
                    configurations: quill.QuillSimpleToolbarConfigurations(controller: _quillController, toolbarSize: 35),
                  ),
                  Container(
                    height: 500,
